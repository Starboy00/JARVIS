...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello')) {
        ...
        window.open("spotify:"); // This will work if Spotify is installed and associated correctly
        ...
        window.open("mspaint.exe");
        speak("Opening Paint...");
    } else if (message.includes('open outlook')) {
        window.open("mailto:"); // Opens the default email client
        speak("Opening Outlook...");
    } else if (message.includes('open file explorer')) {
        window.open("file:///"); // Opens the File Explorer
        speak("Opening File Explorer...");
    } else if (message.includes('open skype')) {
        window.open("skype:"); // Opens Skype if installed
        speak("Opening Skype...");
